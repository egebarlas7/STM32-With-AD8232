...
int beatThreshold = 350;                     //Limit point to be taken as a Pulse
...
void loop() {
  ...
  if (leadsAreOff) {                //Electrod connection correction
    ...
    //4085 - 2047 -1023
    int plotY = map(sensorValue, 0, 4095, 45, 5);                           // Map the raw sensor value (0-2048) to a vertical screen coordinate (45-5)
